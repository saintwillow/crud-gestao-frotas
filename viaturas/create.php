...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (!$erros) {
    ...
    $sql = "INSERT INTO viaturas (matricula, marca_modelo, tipo, combustivel, quilometragem, estado, observacoes)
            VALUES ('$matricula_s', '$marca_modelo_s', '$tipo_s', '$comb_s', $km, '$estado_s', $obs_sql)";
