...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (urlParams.has('msg') || urlParams.has('ok') || urlParams.has('err')) {
      ...
      } else if (msg === 'editada' || msg === 'editado' || ok === 'editado' || ok === 'editada' || msg === 'atualizada') {
      ...
      } else if (msg === 'encerrada') {
        showToast('Atribuição encerrada com sucesso!', 'success');
      } else if (msg === 'manutencao') {
        showToast('Convertido em manutenção com sucesso!', 'success');
      } else if (msg === 'tratada') {
        showToast('Ocorrência tratada com sucesso!', 'success');
      } else if (msg === 'cancelada') {
        showToast('Ordem de serviço cancelada.', 'info');
